...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<OnboardingSlideData> _slides = [
    OnboardingSlideData(
      ...
      subtitle:
          "Rassemblez toutes vos cartes de fidélité dans un seul portefeuille minimaliste et élégant.",
      visualBuilder: (context, active) => _WalletVisual(active: active),
    ),
    OnboardingSlideData(
      title: "Privilèges Uniques",
      subtitle:
          "Gagnez des tampons à chaque visite et obtenez des avantages exclusifs chez vos restaurateurs favoris.",
      visualBuilder: (context, active) => _RewardsVisual(active: active),
    ),
    OnboardingSlideData(
      title: "Partager l'Élégance",
      subtitle:
          "Invitez vos proches et débloquez des avantages exceptionnels grâce à votre code de parrainage exclusif.",
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    style: TextButton.styleFrom(
                      foregroundColor: AppColors.encre.withValues(alpha: 0.6),
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                    color: AppColors.laitonBrosse, width: 1),
                              ),
                              child: const Center(
                                child: Icon(Icons.star_border,
                                    size: 10, color: AppColors.laitonBrosse),
                              ),
                            ),
                          ],
                        ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppColors.saugePale.withValues(alpha: 0.35),
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: stamped
              ? AppColors.vertBouteille
              : AppColors.laitonLisere(opacity: 0.45),
          width: stamped ? 1.5 : 1,
